...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true}, (error, {body} = {}) => {
        if (error) {
            ...
            callback(undefined, body.current.weather_descriptions[0] + ' and Temperature : ' + body.current.temperature + ' degrees . Feeling temperature :  '+ body.current.feelslike +' degrees')
        }
